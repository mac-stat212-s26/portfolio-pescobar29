...
ggplot(company_size, aes(x = reorder(company_size, total_share), y = total_share)) +
  ...
  labs(title = "Capital Share Among Top 10% Firms by Company Size",
       x = "Company Size",
       y = "Share of Top 10% Capital (%)") +
  theme_minimal()
```
...
ggplot(legal_nature, aes(x = legal_nature, y = total_share)) +
  ...
  labs(title = "Capital Share Among Top 10 Firms by Legal Nature",
       x = "Legal Nature",
...
ggplot(owner_qualification, aes(x = owner_qualification, y = total_share)) +
  ...
  labs(title = "Capital Share Among Top 10 Firms by Owner Qualification",
